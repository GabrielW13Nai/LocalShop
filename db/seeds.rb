...
puts "seeding......."
  ...
  User.create([
    {name: "John Doe", email: "john@example.com", password: "password123", phone_number: 1234567890, user_image: "https://media.licdn.com/dms/image/C4E03AQGRHFW7tdEtRQ/profile-displayphoto-shrink_800_800/0/1652422835017?e=2147483647&v=beta&t=yLt2l7n1BSV-beHjH6cc3fm2Gtdjlt2JllKI--XACnM", role: "admin"},
    {name: "Jane Smith", email: "jane@example.com", password: "pass321word", phone_number: 9876543210,  user_image: "https://media.licdn.com/dms/image/C4E03AQGRHFW7tdEtRQ/profile-displayphoto-shrink_800_800/0/1652422835017?e=2147483647&v=beta&t=yLt2l7n1BSV-beHjH6cc3fm2Gtdjlt2JllKI--XACnM", role: "clerk"},
    {name: "John Frank", email: "john@2example.com", password: "pass321word", phone_number: 9876543210, user_image: "https://media.licdn.com/dms/image/C5103AQFAguY6P77jLw/profile-displayphoto-shrink_800_800/0/1517439307640?e=2147483647&v=beta&t=F0c7O-r-L-gNVJIv1tR5RM__mcoei9lWZzRUEKl_e7A", role: "clerk"},
    {name: "Peter Parker", email: "peter@example.com", password: "pass456word", phone_number: 7294732102, user_image: "https://media.licdn.com/dms/image/C5603AQHNfaZ2bUlXtQ/profile-displayphoto-shrink_800_800/0/1588597828172?e=2147483647&v=beta&t=uXnePZBGZFmMp1ou8Xobg6fCwmU19x65-z2mvAKOqZI", role: "super_admin"}
  ])

  Item.create!([
    { name: "Dining table", quantity: 10,destroyed_items: 2,status_of_item: "active",buying_price: 5.99, selling_price: 9.99, user_id: 4},
    { name: "Foldable chair",quantity: 5, destroyed_items: 0,status_of_item: "active",buying_price: 8.99, selling_price: 14.99,user_id: 6},
    {name: "TV Console", quantity: 3, destroyed_items: 1, status_of_item: "inactive", buying_price: 6.99, selling_price: 11.99, user_id: 3}
  ])
